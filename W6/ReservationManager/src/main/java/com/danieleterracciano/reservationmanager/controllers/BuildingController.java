...
public class BuildingController {
	...
	@GetMapping("/buildings/cities/{city}")
	public Page<Building> findBuildingByCity(@PathVariable("city") String city, Pageable p) {
		
		return bs.getBuildingByCity(city, p);
